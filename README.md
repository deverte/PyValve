...
PyValve - программа-клиент, запрашивающая с сервера данные давления, а так же, управляющая экспериментальной установкой по определенному пользователем плану.
  ...
  - Устанавливаете настройки
  - Инициализируете команды
  - Составляете план
  - Программа следует плану и сохраняет данные

## Содержание:
1. [Техническая информация](#Техническая_информация)
2. [Спецификация входных файлов](#Спецификация_входных_файлов)
    1. [settings]
    2. [plan]
    3. [commands]
3. [Спецификация выходных файлов](#Спецификация_выходных_файлов)
    1. [protocol]
    2. [pressures]
4. [License](#License)
